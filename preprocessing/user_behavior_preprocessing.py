"""User-behavior-agent preprocessing."""
...
def run(base_dir: str = "datasets", output_dir: str = "datasets_processed") -> str:
    ...
    source = base / "user_behavior" / "user_email_behavior.csv"
    if not source.exists():
        return ""

    frame = pd.read_csv(source)
    return write_processed_dataset(frame, output / "user_behavior_training.csv")
