"""
Model loader for the Sandbox Behavior Agent.
...
class ModelLoader:
    """Loads and caches the ML model for sandbox_agent."""

    def __init__(self, model_path: str = "models/sandbox_agent/"):
...
def load_model(model_path: str = "models/sandbox_agent/") -> Any:
